...
class FruityWidget extends StatefulWidget {
  ...
  @override
  State<FruityWidget> createState() => _FruityWidgetState();
}

class _FruityWidgetState extends State<FruityWidget> {
  late FruityModel fruityModel = FruityModel();

  @override
  void initState() {
    super.initState();
    fruityModel.initState(context);
  }
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Image.asset(
                      'assets/images/strawberry_2.jpeg',
                      width: 200,
                      height: 200,
                      fit: BoxFit.cover,
                    ),
              ...
              Column(
                children: [
                  ...
                  buildCheckboxRow('Passion Fruit', fruityModel.checkboxValue2, (newValue) {
                    setState(() {
                      fruityModel.checkboxValue2 = newValue;
                    });
                  }),
                  buildCheckboxRow('Berry', fruityModel.checkboxValue3, (newValue) {
                    setState(() {
                      fruityModel.checkboxValue3 = newValue;
                    });
                  }),
                  buildCheckboxRow('Strawberry', fruityModel.checkboxValue4, (newValue) {
                    setState(() {
                      fruityModel.checkboxValue4 = newValue;
                    });
                  }),
                  buildCheckboxRow('Green Apple', fruityModel.checkboxValue5, (newValue) {
                    setState(() {
                      fruityModel.checkboxValue5 = newValue;
                    });
                  }),
                  buildCheckboxRow('Cherry', fruityModel.checkboxValue6, (newValue) {
                    setState(() {
                      fruityModel.checkboxValue5 = newValue;
                    });
                  }),
